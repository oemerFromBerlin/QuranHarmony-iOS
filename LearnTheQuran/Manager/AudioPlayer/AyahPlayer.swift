...
class AyahhPlayer: ObservableObject {
    ...
    @Published var currentPlayingAyah: AyahAudio?
...
//        let seekTime = CMTime(seconds: seconds, preferredTimescale: 1.0)
...
//    }
    ...
    func next() {
        if currentIndex < currentSurah4Audio.count - 1 {
            ...
            currentPlayingAyah = currentSurah4Audio[currentIndex]
